              ...
              <div class="widget-content nopadding">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
	                  ...
	                  <input type="password" id="pass_1" name="contrasena" class="form-control" value="<%= pass %>" placeholder="ContraseÒa"  onchange="validaPass(this.value)" required >
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                   <input type="password" id="pass_2" name="contrasena2" class="form-control" placeholder="Repita la contrase√±a" onchange="validaPass2(this.value)" required>
