  ...
  <div class="container-fluid">
    ...
    <thead>
      <tr >
        ...
        <th><h5 style="text-align:center; ">MODIFICAR <a href="#" title="Clickee en el icono correspondiente al proveedor para modificarlo" class="tip-bottom"><i class="icon-question-sign"> </a></i></h5></th>
...
<%
	...
	%>
	   ...
	   <td><form method="post" action="modProveedorEA.jsp">
           <input type="hidden" id="cuit" name="cuit" value="<%= ctrl.listarProveedores().get(indice).getCuit()%>" >
            ...
            <button style="margin:auto;display:block;" class="btn2" name="modificarProveedor" style="margin:auto; display:block;" id="modificarProveedor" onClick="">
