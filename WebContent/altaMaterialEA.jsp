...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Menu</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-user"></i> <span>Cliente</span> </a>
      ...
      <ul>
        <li class="active"><a href="altaMaterialEA.jsp">Crear Material</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">Crear Material</a></div>
        ...
        <div class="widget-content nopadding">
          ...
          <input type="hidden" id="tipo_em" name="tipo_em" value="<%=tipo_em%>" >
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="descripcion" id="descripcion" placeholder="Descripcion material" onchange="validaDescripcion(this.value)" />
              	<a href="#" title="Ingrese la descripcion del nuevo material" class="tip-right"><i class="icon-question-sign"> </a></i>
