  ...
  <ul>
   ...
   <li class="submenu "> <a href="#"><i class="icon icon-barcode"></i> <span>Producto</span> </a>
    ...
    <li class="submenu active"> <a href="#"><i class="icon icon-user"></i> <span>Proveedores</span> </a>
      <ul>
        <li class="submenu active"><a href="altaProveedorEA.jsp">Crear Proveedor</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">Crear Proveedor</a></div>
