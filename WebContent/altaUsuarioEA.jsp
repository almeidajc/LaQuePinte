           ...
           <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="widget-content nopadding">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="password" id="pass_1" name="contrasena" class="form-control" placeholder="Contrase�a" required>
            <label for="contrasena" style="color:red" id="msjPass_1"></label><br/>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                   <input type="password" id="pass_2" name="contrasena2" class="form-control" placeholder="Repita la contrase�a" required>
