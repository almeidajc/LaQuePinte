  ...
  <ul>
    ...
    <li class="submenu active"> <a href="#"><i class="icon icon-user"></i> <span>Empleado</span> </a>
      <ul>
        ...
        <li class="active"><a href="bajaUsuarioEA.jsp">Eliminar Empleado</a></li>
    ...
    <thead>
      <tr >
        ...
        <th><h5 style="text-align:center; ">TURNO</h5></th>
         <th><h5 style="text-align:center; ">ELIMINAR <a href="#" title="Clickee en el icono correspondiente al empleado para eliminarlo" class="tip-bottom"><i class="icon-question-sign"> </a></i></h5></th>
