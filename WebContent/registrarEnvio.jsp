...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Menu CAMIONERO</a>
  <ul>
    ...
    <li class="active"><a href="registrarEnvio.jsp"><i class="icon icon-truck"></i> <span>Registrar Env�o</span></a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"><a href="indexCA.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Registrar Env�o</a></div>
    <!--End-breadcrumbs-->
