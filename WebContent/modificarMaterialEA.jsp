    ...
    <thead>
      <tr >
        ...
        <th><h5 style="text-align:center; ">DESCRIPCION</h5></th>
         <th><h5 style="text-align:center; ">MODIFICAR <a href="#" title="Clickee en el icono correspondiente al material para modificarlo" class="tip-bottom"><i class="icon-question-sign"> </a></i></h5></th>
...
<%
	...
	for (int indice = 0; indice < ctrl.listarMateriales().size(); indice++){
		String desc=ctrl.listarMateriales().get(indice).getDescripcion();
		if(desc==null){
			desc="-";
		}
