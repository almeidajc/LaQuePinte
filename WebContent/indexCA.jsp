...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Menu CAMIONERO</a>
  <ul>
    ...
    <li><a href="registrarEnvio.jsp"><i class="icon icon-truck"></i> <span>Registrar Env&iacute;o</span></a></li>
   <!--  <li><a href="interface.html"><i class="icon icon-pencil"></i> <span>Eelements</span></a></li> -->
    <li><a href="resumenEnvios.jsp"><i class="icon icon-list-ol"></i> <span>Resumen Env&iacute;os</span></a></li>
  ...
  <div class="container-fluid"><hr>
    ...
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ls span8"> <a href="registrarEnvio.jsp"> <i class="icon-truck"></i> Registrar Env&iacute;o</a> </li>
        
        <li class="bg_lg span8"> <a href="resumenEnvios.jsp"> <i class="icon-list-ol"></i> Resumen de Env&iacute;os</a> </li>
