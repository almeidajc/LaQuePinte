	...
	%>  
	   ...
	   <td><h5 style="text-align:center; "><%= ctrl.listarProveedores().get(indice).getTel() %></h5></td>
	    <td><form method="post" action="BajaProveedor">
           ...
           <button type="submit" class="btn2" name="bajaproveedor" id="bajaproveedor" onClick="return confirm('�Esta Seguro que deseas dar de baja este proveedor?')">
