...
public class PedidoActual extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String msj="";
			if(!esEntero(request.getParameter("txtCod"))) msj+="El código de producto debe ser un numero entero. \n";
			if(!esEntero(request.getParameter("txtCantidad"))) msj+="La cantidad debe ser un numero entero. \n";
